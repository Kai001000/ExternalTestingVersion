...
### 20260907 Validated Market View Update
Latest validated package:
- source package: `RawData/1 page update/20260907.zip`
- source package size: 264,926 bytes
- update path: verified existing-DAT manual path because `RawData/DAT/2026/20260907` already existed and was non-empty
- wrapper command: not used for extraction/build because existing DAT had to be verified first
- equivalent manual commands: `.\.venv\Scripts\python.exe refresh_dat_manifest.py --min_year 2026 --max_year 2026`; `.\.venv\Scripts\python.exe build_fact_sales_year.py --overwrite --min_year 2026 --max_year 2026`; `.\.venv\Scripts\python.exe build_mart_daily_rolling.py`
- primary wrapper exit result: not run for this batch
- recovery command for native mart crash: not used; no native crash occurred
- DAT extraction directory: `RawData/DAT/2026/20260907`
- DAT files used: 123

Run note:
- The ZIP was readable, `bad_member` was `None`, and it contained 123 `.DAT` files.
- The pre-existing DAT directory contained 123 `.DAT` files and matched the ZIP by count, filename set, file size, and SHA256.
- An initial unscoped manifest refresh scanned all years and was not used as the final artifact; final manifest generation used the wrapper-equivalent 2026 scope.
- Fact rebuild and daily rolling mart rebuild completed successfully.

Validated outputs from the 20260907 run:
...
- DAT count: 125 -> 123 for the weekly ZIP batch
- manifest rows: 4,255 -> 4,378
- `fact_sales_2026` rows: 107,539 -> 110,884
- `fact_sales_2026` latest `contract_date`: `2026-08-27` -> `2026-09-03`
- rows after previous max `contract_date` `2026-08-27`: 27
- rows on latest `contract_date` `2026-09-03`: 4
- new 2026 fact rows: 3,345 total; 27 after `2026-08-27`; 3,318 historical backfill at or before `2026-08-27` (99.19%)
- NSW rolling rows/latest date: 12,069 / `2026-08-27` -> 12,083 / `2026-09-03`
- Region rolling rows/latest date: 23,731 / `2026-08-27` -> 23,759 / `2026-09-03`
- Market Region/`REGION16` rolling rows/latest date: 207,168 / `2026-08-27` -> 207,436 / `2026-09-03`
- Suburb rolling rows/latest date: 9,956,663 / `2026-08-27` -> 9,973,382 / `2026-09-03`
- Postcode rolling rows/latest date: 3,995,566 / `2026-08-27` -> 4,001,934 / `2026-09-03`

Validation notes:
- duplicate-row checks returned 0 for manifest, fact, and all five `daily_rolling_*` mart files
- no fact or mart dates were later than the batch date `2026-09-07`
- the update is predominantly historical registration backfill because only 27 of the 3,345 added 2026 fact rows are after `2026-08-27`
- latest `contract_date` `2026-09-03` has 4 fact rows and should be treated as provisional registration-lag data
- latest ten fact contract-date counts are: `2026-08-24` 9, `2026-08-25` 17, `2026-08-26` 8, `2026-08-27` 10, `2026-08-28` 9, `2026-08-30` 1, `2026-08-31` 8, `2026-09-01` 4, `2026-09-02` 1, `2026-09-03` 4
- Region16 check found no stale mart-build indication: statewide fact rows after `2026-08-27` total 27, Region16-mapped rows after `2026-08-27` total 9, mapped max `contract_date` is `2026-09-03`, Region16 mart max date is `2026-09-03`, and mapped rows after the Region16 mart max are 0
...
- local Streamlit server smoke on port `8510` returned 200 from `/_stcore/health`; `/` and `/Market_View` returned 200; Playwright rendered `/Market_View` with latest date `2026-09-03` and no Traceback/Exception text
- real-data selector validation confirmed saved state `Macquarie Park (2113)` coerces to actual option `MACQUARIE PARK (2113)` and the `HOUSE + 1 Year` selector path does not reset
...
### 20260831 Validated Market View Update
Latest validated package:
- source package: `RawData/1 page update/20260831.zip`
- source package size: 392,210 bytes
- primary update command: `.\.venv\Scripts\python.exe scripts\update_market_view_from_zip.py --date 20260831`
- primary wrapper exit result: exit code 0
- recovery command for native mart crash: not used; no native crash occurred
- DAT extraction directory: `RawData/DAT/2026/20260831`
...
- The ZIP was readable, `bad_member` was `None`, and it contained 125 `.DAT` files.
- Post-extraction DAT verification matched the ZIP by count, filename set, file size, and SHA256.
- The primary wrapper completed extraction, manifest refresh, fact rebuild, and daily rolling mart rebuild successfully.

Validated outputs from the 20260831 run:
...
- DAT count: 127 -> 125 for the weekly ZIP batch
- manifest rows: 4,130 -> 4,255
- `fact_sales_2026` rows: 102,058 -> 107,539
- `fact_sales_2026` latest `contract_date`: `2026-08-20` -> `2026-08-27`
- rows after previous max `contract_date` `2026-08-20`: 23
- rows on latest `contract_date` `2026-08-27`: 4
- new 2026 fact rows: 5,481 total; 23 after `2026-08-20`; 5,458 historical backfill at or before `2026-08-20`
- NSW rolling rows/latest date: 12,055 / `2026-08-20` -> 12,069 / `2026-08-27`
- Region rolling rows/latest date: 23,703 / `2026-08-20` -> 23,731 / `2026-08-27`
- Market Region/`REGION16` rolling rows/latest date: 206,847 / `2026-08-19` -> 207,168 / `2026-08-27`
- Suburb rolling rows/latest date: 9,940,112 / `2026-08-20` -> 9,956,663 / `2026-08-27`
- Postcode rolling rows/latest date: 3,989,462 / `2026-08-20` -> 3,995,566 / `2026-08-27`

Validation notes:
- duplicate-row checks returned 0 for manifest, fact, and all five `daily_rolling_*` mart files
- the update is predominantly historical registration backfill because only 23 of the 5,481 added 2026 fact rows are after `2026-08-20`
- latest `contract_date` `2026-08-27` has 4 fact rows and should be treated as provisional registration-lag data
- latest seven fact contract-date counts are: `2026-08-19` 9, `2026-08-20` 11, `2026-08-21` 6, `2026-08-24` 7, `2026-08-25` 4, `2026-08-26` 2, `2026-08-27` 4
- Region16 check found no stale mart-build indication: statewide fact rows after `2026-08-19` total 34, Region16-mapped rows after `2026-08-19` total 4, mapped max `contract_date` is `2026-08-27`, Region16 mart max date is `2026-08-27`, and mapped rows after the Region16 mart max are 0
- `.\.venv\Scripts\python.exe -m pytest` was attempted; current `.venv` does not have `pytest` installed
- `.\.venv\Scripts\python.exe -m unittest tests.test_market_view_area_selection` passed: 8 tests
- `py_compile` passed for `home.py`, `pages/1_Market_View.py`, `utils/data.py`, `utils/i18n.py`, `utils/market_view_area.py`, `utils/tables.py`, and `tests/test_market_view_area_selection.py`
- local Streamlit server smoke on port `8510` returned 200 from `/_stcore/health`; `/` and `/Market_View` returned 200; Playwright rendered `/Market_View` with latest date `2026-08-27` and no Traceback/Exception text
- real-data selector validation confirmed saved state `Macquarie Park (2113)` coerces to actual option `MACQUARIE PARK (2113)` and the `HOUSE + 1 Year` empty-state path does not reset the selector
- deployment branch: `deploy/streamlit-cloud-safe-2026-03-29`
- final commit hash is reported in the session handoff after commit creation

### 20260824 Validated Market View Update
Latest validated package:
- source package: `RawData/1 page update/20260824.zip`
- source package size: 250,895 bytes
- primary update command: `.\.venv\Scripts\python.exe scripts\update_market_view_from_zip.py --date 20260824`
- primary wrapper exit result: exit code 0
- recovery command for native mart crash: not used; no native crash occurred
- DAT extraction directory: `RawData/DAT/2026/20260824`
...
Validated outputs from the 20260824 run:
...
- DAT count: 121 -> 127 for the weekly ZIP batch
- manifest rows: 4,003 -> 4,130
- `fact_sales_2026` rows: 99,034 -> 102,058
- `fact_sales_2026` latest `contract_date`: `2026-08-13` -> `2026-08-20`
- rows after previous max `contract_date` `2026-08-13`: 19
- rows on latest `contract_date` `2026-08-20`: 2
- NSW rolling rows/latest date: 12,041 / `2026-08-13` -> 12,055 / `2026-08-20`
- Region rolling rows/latest date: 23,675 / `2026-08-13` -> 23,703 / `2026-08-20`
- Market Region/`REGION16` rolling rows/latest date: 206,528 / `2026-08-11` -> 206,847 / `2026-08-19`
- Suburb rolling rows/latest date: 9,924,808 / `2026-08-13` -> 9,940,112 / `2026-08-20`
- Postcode rolling rows/latest date: 3,983,089 / `2026-08-13` -> 3,989,462 / `2026-08-20`

Validation notes:
- duplicate-row checks returned 0 for manifest, fact, and all five `daily_rolling_*` mart files
- only 19 of the 3,024 added 2026 fact rows are after `2026-08-13`; the update is mainly historical backfill
- latest `contract_date` `2026-08-20` has 2 fact rows and should be treated as provisional registration-lag data
- latest seven fact contract-date counts are: `2026-08-12` 12, `2026-08-13` 7, `2026-08-14` 8, `2026-08-17` 4, `2026-08-18` 3, `2026-08-19` 2, `2026-08-20` 2
- Region16 lags NSW/Region by one day, but mapped coverage explains the lag: after `2026-08-11`, statewide fact rows total 38, Region16-mapped rows total 5, mapped max `contract_date` is `2026-08-19`, and mapped rows after the Region16 mart max are 0
- `.\.venv\Scripts\python.exe -m pytest` was attempted; current `.venv` does not have `pytest` installed
- `.\.venv\Scripts\python.exe -m unittest tests.test_market_view_area_selection` passed: 8 tests
- `py_compile` passed for `home.py`, `pages/1_Market_View.py`, `utils/data.py`, `utils/i18n.py`, `utils/market_view_area.py`, `utils/tables.py`, and `tests/test_market_view_area_selection.py`
- local Streamlit server smoke on port `8510` returned 200 from `/_stcore/health`; `/` and `/Market_View` returned 200; Playwright rendered `/Market_View` with latest date `2026-08-20` and no Traceback/Exception text
- real-data selector validation confirmed saved state `Macquarie Park (2113)` coerces to actual option `MACQUARIE PARK (2113)` and the `HOUSE + 1 Year` empty-state path does not reset the selector
- deployment branch: `deploy/streamlit-cloud-safe-2026-03-29`
- final commit hash is reported in the session handoff after commit creation

### 20260817 Validated Market View Update
Latest validated package:
- source package: `RawData/1 page update/20260817.zip`
- source package size: 212,542 bytes
- primary update command: `.\.venv\Scripts\python.exe scripts\update_market_view_from_zip.py --date 20260817`
- primary wrapper exit result: exit code 0
- recovery command for native mart crash: not used; no native crash occurred
- DAT extraction directory: `RawData/DAT/2026/20260817`
...
- The ZIP was readable and contained 121 `.DAT` files.
- The primary wrapper completed extraction, manifest refresh, fact rebuild, and daily rolling mart rebuild successfully.

Validated outputs from the 20260817 run:
...
- DAT count: 123 -> 121 for the weekly ZIP batch
- manifest rows: 3,882 -> 4,003
- `fact_sales_2026` rows: 96,466 -> 99,034
- `fact_sales_2026` latest `contract_date`: `2026-08-05` -> `2026-08-13`
- rows after previous max `contract_date` `2026-08-05`: 23
- rows on latest `contract_date` `2026-08-13`: 1
- NSW rolling rows/latest date: 12,025 / `2026-08-05` -> 12,041 / `2026-08-13`
- Region rolling rows/latest date: 23,643 / `2026-08-05` -> 23,675 / `2026-08-13`
- Market Region/`REGION16` rolling rows/latest date: 206,199 / `2026-08-03` -> 206,528 / `2026-08-11`
- Suburb rolling rows/latest date: 9,909,925 / `2026-08-05` -> 9,924,808 / `2026-08-13`
- Postcode rolling rows/latest date: 3,976,924 / `2026-08-05` -> 3,983,089 / `2026-08-13`

Validation notes:
- duplicate-row checks returned 0 for manifest, fact, and all five `daily_rolling_*` mart files
- only 23 of the 2,568 added 2026 fact rows are after `2026-08-05`; the update is mainly historical backfill
- latest `contract_date` `2026-08-13` has 1 fact row and should be treated as provisional registration-lag data
- Region16 lags NSW/Region, but mapped coverage explains the lag: after `2026-08-03`, statewide fact rows total 38, Region16-mapped rows total 10, and mapped max `contract_date` is `2026-08-11`
- `.\.venv\Scripts\python.exe -m pytest` was attempted; current `.venv` does not have `pytest` installed
- `.\.venv\Scripts\python.exe -m unittest tests.test_market_view_area_selection` passed: 8 tests
- `py_compile` passed for `home.py`, `pages/1_Market_View.py`, `utils/data.py`, `utils/i18n.py`, `utils/market_view_area.py`, `utils/tables.py`, and `tests/test_market_view_area_selection.py`
- Streamlit AppTest rendered NSW, Region, Market Region/`REGION16`, and `MACQUARIE PARK (2113)` AREA saved-state cases with 0 exceptions and latest date `2026-08-13` visible
- local Streamlit server smoke on port `8510` returned 200 from `/_stcore/health`; `/` and `/Market_View` returned 200 with no Traceback/Exception in page bodies
...
### 20260810 Validated Market View Update
Latest validated package:
- source package: `RawData/1 page update/20260810.zip`
- source package size: 213,986 bytes
- primary update command: `.\.venv\Scripts\python.exe scripts\update_market_view_from_zip.py --date 20260810`
- primary wrapper exit result: exit code 0
- recovery command for native mart crash: not used; no native crash occurred
- DAT extraction directory: `RawData/DAT/2026/20260810`
...
Validated outputs from the 20260810 run:
...
- manifest rows: 3,759 -> 3,882
- `fact_sales_2026` rows: 93,875 -> 96,466
- `fact_sales_2026` latest `contract_date`: `2026-07-30` -> `2026-08-05`
- rows after previous max `contract_date` `2026-07-30`: 19
- rows on latest `contract_date` `2026-08-05`: 1
- NSW rolling rows/latest date: 12,013 / `2026-07-30` -> 12,025 / `2026-08-05`
- Region rolling rows/latest date: 23,619 / `2026-07-30` -> 23,643 / `2026-08-05`
- Market Region/`REGION16` rolling rows/latest date: 205,804 / `2026-07-24` -> 206,199 / `2026-08-03`
- Suburb rolling rows/latest date: 9,895,352 / `2026-07-30` -> 9,909,925 / `2026-08-05`
- Postcode rolling rows/latest date: 3,971,409 / `2026-07-30` -> 3,976,924 / `2026-08-05`

Validation notes:
- duplicate-row checks returned 0 for manifest, fact, and all five `daily_rolling_*` mart files
- Region16 lags NSW/Region, but mapped coverage explains the lag: after `2026-07-24`, statewide 2026 fact rows total 60, Region16-mapped rows total 12, and mapped max `contract_date` is `2026-08-03`
- `.\.venv\Scripts\python.exe -m pytest` was attempted; current `.venv` does not have `pytest` installed
- `.\.venv\Scripts\python.exe -m unittest tests.test_market_view_area_selection` passed: 8 tests
- `py_compile` passed for `home.py`, `pages/1_Market_View.py`, `utils/data.py`, `utils/i18n.py`, `utils/market_view_area.py`, `utils/tables.py`, and `tests/test_market_view_area_selection.py`
- Streamlit AppTest rendered Market View with 0 exceptions, latest date `2026-08-05` visible, and selector value `MACQUARIE PARK (2113)`
- local Streamlit server smoke on port `8510` returned 200 from `/_stcore/health`; `/` and `/Market_View` returned 200 with no Traceback/Exception in logs
- `MACQUARIE PARK (2113)` + `HOUSE` + `1 Year` remained selected under the saved-state variant `Macquarie Park (2113)` and produced the expected empty filtered result
- deployment branch: `deploy/streamlit-cloud-safe-2026-03-29`
- final commit hash is reported in the session handoff after commit creation
- latest post-`2026-07-30` fact rows are very thin and should be treated as provisional registration-lag data

### 20260803 Validated Market View Update
Previous validated package:
